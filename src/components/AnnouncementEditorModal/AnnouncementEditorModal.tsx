    ...
    >
      ...
      >
        ...
        <div className="flex flex-col gap-1.5">
          <label
            htmlFor="announcementEditorTitle"
        ...
        <div className="flex flex-col gap-1.5">
          <label
            htmlFor="announcementEditorContent"
            className="text-sm font-medium text-[var(--color-text-primary)]"
          >
            Conteúdo
          </label>
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="text-xs text-[var(--color-text-muted)]">
            Opcional. Se nenhuma imagem for enviada, o aviso será publicado
            apenas com texto.
          </p>
          ...
          {editingAnnouncement && imagePath && !imageFile && !imagePreview && (
            <div className="flex items-center justify-between rounded-lg border border-[var(--color-border)] bg-[var(--color-surface)] px-3 py-2">
              <p className="text-xs text-[var(--color-text-muted)]">
                Imagem atual mantida. Selecione acima para substituir ou remova
                para salvar sem imagem.
              </p>
              {!isSubmitting && (
                <button
                  type="button"
        ...
        <div className="flex flex-col gap-1.5">
          <span className="text-sm font-medium text-[var(--color-text-primary)]">
            Ocultar para (exceção)
          </span>
          <p className="text-xs text-[var(--color-text-muted)]">
            Por padrão, o aviso é visível a todos. Marque os perfis que NÃO
            verão este aviso.
          </p>
