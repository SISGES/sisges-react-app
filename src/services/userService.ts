...
function requireList<T>(value: T[], resource: string): T[] {
  if (!Array.isArray(value)) {
    throw new Error(`Resposta inválida ao carregar ${resource}.`);
  }
  return value;
}
...
export async function searchUsers(
  ...
  const response = await api.post<UserSearchResponse[]>(
    "/users/search",
    filters,
  );
  return requireList(response, "usuários");
}
...
export async function searchTeachers(
  ...
  const response = await api.post<TeacherSearchResponse[]>(
    "/teachers/search",
    filters,
  );
  return requireList(response, "professores");
}
...
export async function searchStudents(
  ...
  const response = await api.post<StudentSearchResponse[]>(
    "/students/search",
    filters,
  );
  return requireList(response, "alunos");
}
...
export async function searchClasses(
  ...
  const response = await api.post<ClassSearchResponse[]>(
    "/classes/search",
    filters,
  );
  return requireList(response, "turmas");
}
...
export async function searchResponsibles(
  filters?: ResponsibleSearchFilters,
): Promise<ResponsibleSearchResponse[]> {
  const response = await api.post<ResponsibleSearchResponse[]>(
    "/responsibles/search",
    filters,
  );
  return response;
...
export async function addTeacherToClass(
  ...
  const response = await api.post<ClassDetailResponse>(
    `/classes/${classId}/teacher/add/${teacherId}`,
  );
  return response;
}
...
export async function addStudentToClass(
  ...
  const response = await api.post<ClassDetailResponse>(
    `/classes/${classId}/student/add/${studentId}`,
  );
  return response;
}
...
export async function removeTeacherFromClass(
  ...
  const response = await api.post<ClassDetailResponse>(
    `/classes/${classId}/teacher/remove/${teacherId}`,
  );
  return response;
}
...
export async function removeStudentFromClass(
  ...
  const response = await api.post<ClassDetailResponse>(
    `/classes/${classId}/student/remove/${studentId}`,
  );
  return response;
}
...
export async function getDisciplines(): Promise<DisciplineResponse[]> {
  ...
  return requireList(response, "disciplinas");
}
...
export async function updateDiscipline(
  ...
  const response = await api.put<DisciplineResponse>(
    `/disciplines/update/${id}`,
    data,
  );
  return response;
}
...
export async function addDisciplineToClass(
  ...
  const response = await api.post<ClassDetailResponse>(
    `/classes/${classId}/discipline/add/${disciplineId}`,
  );
  return response;
}
...
export async function removeDisciplineFromClass(
  ...
  const response = await api.post<ClassDetailResponse>(
    `/classes/${classId}/discipline/remove/${disciplineId}`,
  );
  return response;
}

export async function searchAulas(
  filters?: AulaSearchFilters,
): Promise<AulaSearchResponse[]> {
  const body: {
    date?: string;
    disciplineId?: number;
    classId?: number;
  ...
  const response = await api.post<
    Array<
      Omit<AulaSearchResponse, "schoolClassName"> & {
        className?: string;
        schoolClassName?: string;
      }
    >
  >("/class/search", body);
  return requireList(response, "aulas").map((meeting) => ({
    ...meeting,
    schoolClassName: meeting.schoolClassName ?? meeting.className ?? "-",
  }));
}
...
export async function createAula(
  data: CreateAulaRequest,
): Promise<AulaDetailResponse> {
...
export async function updateAula(
  id: number,
  data: UpdateAulaRequest,
): Promise<AulaDetailResponse> {
  const response = await api.put<AulaDetailResponse>(
    `/class/update/${id}`,
    data,
  );
  return response;
...
export async function submitAulaFrequency(
  aulaId: number,
  data: SubmitFrequencyRequest,
): Promise<void> {
