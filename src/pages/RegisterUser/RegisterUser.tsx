...
export function RegisterUser() {
  ...
  const refreshClasses = async () => {
    try {
      setAvailableClasses(await searchClasses());
    } catch {
      void 0;
    }
  };
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      showToast(
        `Usuário "${response.name}" cadastrado como ${getRoleLabel(response.role)}.`,
        "success",
      );
      resetForm();
  ...
  const sectionCls =
    "bg-[var(--color-surface)] border border-[var(--color-border)] rounded-lg p-5 flex flex-col gap-4";
        ...
        <div className="flex flex-col gap-6">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-6">
            ...
            {role === "STUDENT" && (
              <>
                <div className={sectionCls}>
                  <p className="text-sm font-semibold text-[var(--color-text-primary)] border-b border-[var(--color-border)] pb-2">
                    Dados do Aluno
                  </p>
                  <FormField
                  ...
                  {responsibleMode === "existing" ? (
                    ...
                    <>
                      <FormField
                        ...
                        required
                        error={fieldErrors["responsibleData.name"]}
                      >
                        <Input
                          value={responsibleData.name}
                          onChange={(e) =>
                            setResponsibleData((p) => ({
                              ...p,
                              name: e.target.value,
                            }))
                          }
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <FormField
                          label="Telefone"
                          required
                          error={fieldErrors["responsibleData.phone"]}
                        >
                          <Input
                            type="text"
                            inputMode="numeric"
                        ...
                        <FormField label="Telefone Alternativo">
                          <Input
                            ...
                            onChange={(e) =>
                              setResponsibleData((p) => ({
                                ...p,
                                alternativePhone: formatPhone(e.target.value),
                              }))
                            }
                            placeholder="(31) 97215-2822"
                            maxLength={15}
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <FormField
                          ...
                          required
                          error={fieldErrors["responsibleData.email"]}
                        >
                          <Input
                            type="email"
